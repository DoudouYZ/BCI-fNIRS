<<<<<<< HEAD:Basic_Classifier/phase_amplitude_classification_own_experiment.py
import os
import numpy as np
...
print(f"Control Split (HbR): combined p = {result_ctrl_hbr['p_combined']:.4g} "
      f"(phase p = {result_ctrl_hbr['p_phase']:.4g}, power p = {result_ctrl_hbr['p_power']:.4g})")
# =========================  END APPEND  =========================
>>>>>>> b131bf0955bb97d599737089a0c502fb988f4c63:Basic_Classifier/phase_amplitude_classification_own_data.py
